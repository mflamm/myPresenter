 ...
 *  @brief      A media file representing an image.
 *
 *
 ********************************************************************
 *
...
class Image extends Media {
    ...
    Image(final Context context, final String absolutePath) {
        super(context, absolutePath);
    }

    @Override
    public Bitmap createThumbnail() {
        return ImageBitmapCreator.createThumbnail(this);
    }

    @Override
    public Bitmap createFullscreenImage() {
        return ImageBitmapCreator.createFullscreenImage(this);
    }
