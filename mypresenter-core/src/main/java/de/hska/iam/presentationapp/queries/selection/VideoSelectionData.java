 ...
 *                   Karlsruhe
 *
 *  @file       VideoSelectionData.java
 *  @package	de.hska.iam.presentationapp.queries.selection
 *  @brief	    Holds the selection data for videos.
 *
 *
 ********************************************************************
 *
...
public class VideoSelectionData implements SelectionData {

    private static final String SELECTION = MediaStore.Files.FileColumns.MEDIA_TYPE + " = ?";
    private static final String SELECTION_ARG = String.valueOf(MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO);
