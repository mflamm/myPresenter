 ...
 *                   Karlsruhe
 *
 *  @file       PdfSelectionData.java
 *  @package	de.hska.iam.presentationapp.queries.selection
 *  @brief	    Holds the selection data for pdfs.
 *
 *
 ********************************************************************
 *
...
public class PdfSelectionData implements SelectionData {

    private static final String SELECTION = MediaStore.Files.FileColumns.MIME_TYPE + " = ?";
    private static final String SELECTION_ARG = MimeTypeMap.getSingleton().getMimeTypeFromExtension("pdf");
