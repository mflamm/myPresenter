...
import com.artifex.mupdfdemo.link.*;
...
public class MuPDFReaderView extends ReaderView {
	...
	private ReaderMode mReaderMode = ReaderMode.Viewing;
	...
	public boolean onSingleTapUp(MotionEvent e) {
		...
		if (mReaderMode == ReaderMode.Viewing && !tapDisabled) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if ( mReaderMode == ReaderMode.Drawing )
		{
			float x = event.getX();
			float y = event.getY();
