package com.artifex.mupdfdemo.tasks.search;
...
public abstract class SearchTask {
	...
	private android.os.AsyncTask<Void,Integer,SearchTaskResult> mSearchTask;
	...
	public void go(final String text, int direction, int displayPage, int searchPage) {
		...
		mSearchTask = new android.os.AsyncTask<Void,Integer,SearchTaskResult>() {
			@Override
