...
import com.artifex.mupdfdemo.view.reader.MuPDFActivity;
...
public class ChoosePDFActivity extends ListActivity {
	...
	private ChoosePDFPurpose mPurpose;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		mPurpose = PICK_KEY_FILE.equals(getIntent().getAction()) ? ChoosePDFPurpose.PickKeyFile : ChoosePDFPurpose.PickPDF;
